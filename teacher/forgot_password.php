...
if (isset($_POST['reset'])) {
    ...
    if ($new_pass !== $confirm_pass) {
        ...
        $check = mysqli_query($connection, "SELECT * FROM teachers WHERE email='$email'");
        if (mysqli_num_rows($check) > 0) {
            // Update teacher password
            $update = mysqli_query($connection, "UPDATE teachers SET password='$hashed_password' WHERE email='$email'");
            if ($update) {
            ...
            $msg = "❌ No faculty account found with that email!";
        }
    }
}
?>
        ...
        <div class="col-md-6">
            ...
            <div class="card reset-container">
                <div class="card-header text-center">
                    <strong>Reset Faculty Password</strong>
                </div>
                <div class="card-body">
                    <?php if (!empty($msg)): ?>
