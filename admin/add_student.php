...
if (isset($_POST['add_student'])) {
    ...
    $query = "INSERT INTO students (sid, name, email, st_id, department, joining_year, current_year, passout_year, address, gender, mobile, phone, password) 
              VALUES ('$sid', '$name', '$email', '$st_id','$department', '$joining_year', '$current_year', '$passout_year', '$address', '$gender', '$mobile', '$phone', '$password')";
...
<div class="main-content">
    <div class="">
        ...
        <div class="col-md-6">
           ...
           <div class="col-md-6">
                   <div class="form-group">
                       <label for="phone">Parent No</label>
