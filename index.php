...
if (mysqli_num_rows($query_run)) {
    ...
    if (password_verify($password, $row['password'])) {
        ...
        echo "<script>alert('Invalid Email ID or Password!'); window.location.href = 'index.php';</script>";
    }
}
}
?>
...
<div class="container mt-5">
    <div class="row justify-content-center">
        ...
        <a href="admin/forgot_password.php" style="font-size: 0.9rem; align-self: center;">Forgot Password?</a>
    </div>
