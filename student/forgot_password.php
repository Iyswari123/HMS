...
if (isset($_POST['reset'])) {
    ...
    if ($new_pass !== $confirm_pass) {
        ...
        $check = mysqli_query($connection, "SELECT * FROM students WHERE email='$email'");
        if (mysqli_num_rows($check) > 0) {
            // Update student password
            $update = mysqli_query($connection, "UPDATE students SET password='$hashed_password' WHERE email='$email'");
            if ($update) {
            ...
            $msg = "❌ No student account found with that email!";
        }
    }
}
?>
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="text-center mt-3">
                            <a href="index2.php">← Back to Login</a>
                        </div>
                    </form>
                </div>
            </div>
